...
const Article = () => {
  return (
    <div>
      ...
      <address>
      <i>by Kate Farley</i> (<a href="kate.farley@nytimes.com">kate.farley@nytimes.com</a>)<br />
      </address>
      ...
      <p>But visitors will be able to see the original 3,600-pound torch in all its glory at a new Statue of Liberty Museum, which will open on Liberty Island in May <time datetime="2019">2019</time>. The torch was transported there by truck last week, along with a replica model of Lady Liberty's face.</p>
